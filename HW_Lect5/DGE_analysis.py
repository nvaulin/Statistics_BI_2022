...
def parsing_args():
    ...
    return output, expressions_1, expressions_2
...
def check_dge_with_ztest(first_table, second_table, celltypes=("Cell_type_1", "Cell_type_2")):
...
if __name__ == '__main__':
    output, expressions_1, expressions_2 = parsing_args()
    ...
    z_test_p_values, z_test_results = check_dge_with_ztest(expressions_1, expressions_2)
